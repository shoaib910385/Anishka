...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","II_onlyZerox_II")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Anshi_musicbot")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/shoaib910385/Anishka",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Quantum_not_for_everyone")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Quantum_Discussion_group")
